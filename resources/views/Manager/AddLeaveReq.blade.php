                    ...
                    <form class="leave-form" action="{{ route('leaves.store') }}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="leave_days" name="leave_days" placeholder="Number of days" readonly>
                            </div>
                            
                            <div class="form-group">
                                <label for="type">Leave Type</label>
                                <select id="type" name="type" class="selection-list" required>
                                    <option value="" disabled {{ old('type') === null ? 'selected' : '' }}>Select Leave Type</option>
                                    <option value="0" {{ old('type') == '0' ? 'selected' : '' }}>Normal Leave</option>
                                    <option value="1" {{ old('type') == '1' ? 'selected' : '' }}>Urgent Leave</option>
                                    <option value="2" {{ old('type') == '2' ? 'selected' : '' }}>Half Day Leave</option>
                                </select>
                                @error('type')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
