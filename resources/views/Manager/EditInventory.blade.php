        ...
        <div class="form-section">
            <form action="{{ route('inventory.update', $inventory->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="Itm_id" name="Itm_id" value="{{ old('Itm_id', $inventory->Itm_id) }}"
                        required>
                </div>
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="it_name" name="it_name"
                        value="{{ old('it_name', $inventory->it_name) }}" required>
                </div>
