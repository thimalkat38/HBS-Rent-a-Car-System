        ...
        <div class="form-section">
            <form action="{{ route('crms.update', $crm->id) }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="full_name" name="full_name" value="{{ old('title', $crm->full_name) }}"
                        required>
                </div>
                <div class="form-row">
                    <label for="phone">Phone:</label>
                    <input type="text" id="phone" name="phone" value="{{ old('phone', $crm->phone) }}"
                        required>
                </div>
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="subject" name="subject" value="{{ old('subject', $crm->subject) }}"
                        required>
                </div>
