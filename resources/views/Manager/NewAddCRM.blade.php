        ...
        <div class="flex-1 flex flex-col min-h-screen bg-gray-50">
            ...
            <header class="w-full h-20 bg-white border-b border-gray-200 flex items-center px-8">
                <div class="w-full flex justify-between items-center">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xl font-normal text-gray-700">Add CRM</span>
                    </div>
            ...
            <main class="flex-1 w-full px-0 py-0 flex flex-col h-[calc(100vh-5rem)]">
                <div class="flex justify-center items-start h-full py-8 px-2 overflow-y-auto">
                    <form class="w-full max-w-2xl bg-white rounded-lg shadow-md p-8 space-y-6" action="{{ route('crms.store') }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="full_name" class="block mb-1 text-gray-700 font-semibold">Customer Name</label>
                            ...
                            <div>
                                <label for="phone" class="block mb-1 text-gray-700 font-semibold">Mobile Number</label>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="note" name="note" rows="4" placeholder="Enter any additional notes"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-teal-500 focus:border-teal-500 transition"></textarea>
                        </div>

                        <div class="flex flex-wrap gap-4 justify-end mt-6">
                            <button type="reset"
                                class="px-6 py-2 bg-yellow-200 text-yellow-900 rounded-lg hover:bg-yellow-300 font-semibold transition">CLEAR</button>
                            <button type="submit"
                                class="px-6 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 font-semibold transition">SUBMIT</button>
                        </div>
                    </form>
                </div>
            </main>
