        ...
        <div class="flex-1 flex flex-col min-h-screen">
            ...
            <header class="w-full bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <span class="text-xl font-semibold text-gray-900" data-translate="Add Inventory Item">Add Inventory Item</span>
                </div>
            ...
            <main class="flex-1 p-8 bg-gray-50 overflow-y-auto">
                <div class="max-w-6xl mx-auto">
                    <div class="bg-white rounded-2xl shadow p-8 border border-gray-200">
                        <h2 class="text-2xl font-semibold text-gray-800 mb-6" data-translate="Add Inventory Item">Add New Inventory Item</h2>
                        ...
                        <form action="{{ route('inventory.store') }}" method="POST" enctype="multipart/form-data" id="inventoryForm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1" data-translate="Opening Stock">Opening Stock</label>
                                    <input type="number" name="quantity" id="quantity" placeholder="Opening Stock"
                                        value="{{ old('quantity') }}"
                                        class="w-full h-12 px-3 py-2 bg-gray-100 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500 @error('quantity') border-red-500 @enderror"
                                        required min="1">
                                    @error('quantity')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <!-- Low stock warning -->
                                    <div id="low-stock-alert" class="hidden mt-2 p-2 bg-orange-50 border-l-4 border-orange-400 text-orange-700 text-xs rounded">
                                        <div class="flex items-center">
                                            <span class="material-icons text-orange-500 mr-2 text-sm">warning</span>
                                            <span data-translate="Warning: Current quantity is below the minimum alert level">Warning: Current quantity is below the minimum alert level!</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1" data-translate="Price Per Unit">Price Per Unit</label>
                                    <input type="number" name="price_per_unit" id="price_per_unit"
                                        placeholder="Price Per Unit" value="{{ old('price_per_unit') }}"
                                        class="w-full h-12 px-3 py-2 bg-gray-100 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500 @error('price_per_unit') border-red-500 @enderror"
    ...
    <script>
        ...
        const translations = {
            en: {
                ...
                'Warning: Current quantity is below the minimum alert level': 'Warning: Current quantity is below the minimum alert level!',
            ...
            si: {
                'Add Inventory Item': 'ඉන්වෙන්ටරි භාණ්ඩයක් එකතු කරන්න',
                ...
                'Warning: Current quantity is below the minimum alert level': 'අවවාදය: වත්මන් ප්‍රමාණය අවම අවවාද මට්ටමට වඩා අඩුය!',
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Function to check low stock alert
            ...
            quantityInput.addEventListener("input", checkLowStockAlert);
            minQuantityInput.addEventListener("input", checkLowStockAlert);
        ...
        function removeImage(index) {
            alert('To remove images, please clear the form and select images again.');
        }
    </script>
</body>
</html>