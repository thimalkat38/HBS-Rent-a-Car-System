            ...
            <ul class="space-y-1">
                ...
                <li>
                    ...
                    <ul class="ml-8 space-y-1">
                        ...
                        <li>
                            <a href="{{ url('postbookings') }}" class="flex items-center px-6 py-3 text-teal-500 font-semibold bg-slate-800 rounded-l-full">
            ...
            <div class="max-w-7xl mx-auto space-y-8">
                ...
                <section class="bg-white rounded-2xl shadow p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nic" id="nic" value="{{ $booking->nic }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Enter NIC" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Contact Number</label>
                            <input type="text" name="mobile_number" id="mobile_number" value="{{ $booking->mobile_number }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Enter contact number" />
                        </div>
                    </div>
                </section>
                <!-- Booking Information -->
                <section class="bg-white rounded-2xl shadow p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" name="vehicle" id="vehicle_name" value="{{ $booking->vehicle_name }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Enter vehicle model" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Vehicle Number</label>
                            <input type="text" name="vehicle_number" id="vehicle_number" value="{{ $booking->vehicle_number }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Enter vehicle number" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Price Per Day (LKR)</label>
                            <input type="number" name="price_per_day" id="price_per_day" value="{{ $booking->price_per_day }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Free Tour Per Day (KM)</label>
                            <input type="number" name="free_kmd" id="free_kmd" value="{{ $booking->free_kmd}}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">From</label>
                            <input type="date" name="from_date" id="from_date" value="{{ $booking->from_date }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">To</label>
                            <input type="date" name="to_date" id="to_date" value="{{ $booking->to_date }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Arrived Date</label>
                            <input type="date" name="ar_date" id="ar_date" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Extended Days</label>
                            <input type="number" name="ex_date" id="ex_date" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0" readonly />
                        </div>
                    </div>
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Starting Mileage (KM)</label>
                            <input type="number" name="start_km" id="start_km" value="{{ $booking->start_km }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Ending Mileage (KM)</label>
                            <input type="number" name="end_km" id="end_km" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Drive Mileage (KM)</label>
                            <input type="number" name="drived" id="drived" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Free Tour (KM)</label>
                            <input type="number" name="free_km" id="free_km" value="{{ $booking->free_km }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Over Drive Distance (KM)</label>
                            <input type="number" name="over" id="over" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Extra 1KM Charges (LKR)</label>
                            <input type="number" name="extra_km_chg" id="extra_km_chg" value="{{ $booking->extra_km_chg }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                    </div>
                </section>
                <!-- Billing Information -->
                <section class="bg-white rounded-2xl shadow p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Before Base Price (LKR)</label>
                            <input type="number" name="base_price" id="base_price" value="{{ $booking->price + $booking->payed }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Paid Amount (LKR)</label>
                            <input type="number" name="paid" id="payed" value="{{ $booking->payed }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Payment Note</label>
                            <input type="text" name="method" value="{{ $booking->method }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Payment note" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Due Payment <span class="text-xs font-normal">(Remaining to be pay)</span></label>
                            <input type="number" name="due" id="price" value="{{ $booking->price }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Extra Mileage Charges (LKR)</label>
                            <input type="number" name="extra_km" id="extra_km" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Extra Hour Charges (LKR)</label>
                            <input type="number"name="extra_hours" id="extra_hours" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Damage Fee (LKR)</label>
                            <input type="number" name="damage_fee" id="damage_fee" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Other Additional Charges (LKR)</label>
                            <input type="number" name="after_additional" id="after_additional" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Reason for Additional Charges</label>
                            <input type="text" name="reason" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Reason" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">After Discount Price (LKR)</label>
                            <input type="number" name="after_discount" id="after_discount" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Total Income (LKR)</label>
                            <input type="number" name="total_income" id="total_income" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="0.00" />
                        </div>
                    </div>
                </section>
                ...
                <!-- Release/Check Info -->
                <section class="bg-white rounded-2xl shadow p-8">
                    <div class="flex flex-col md:flex-row md:items-center md:space-x-16 space-y-4 md:space-y-0 mb-8">
                        <div class="flex items-center space-x-2">
                            <input type="checkbox" name="due_paid" value="1"  class="form-checkbox h-5 w-5 text-teal-500 rounded focus:ring-teal-500" />
                            <span class="text-base text-gray-700">Due paid checked</span>
                        </div>
                        <div class="flex items-center space-x-2">
                            <input type="checkbox" name="deposit_refunded" value="1"  class="form-checkbox h-5 w-5 text-teal-500 rounded focus:ring-teal-500" />
                            <span class="text-base text-gray-700">Due paid checked</span>
                        </div>
                        <div class="flex items-center space-x-2">
                            <input type="checkbox" name="vehicle_checked" value="1"  class="form-checkbox h-5 w-5 text-teal-500 rounded focus:ring-teal-500" />
                            <span class="text-base text-gray-700">Vehicle</span>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Released Officer’s Name</label>
                            <input type="text" name="rel_officer" value="{{ $booking->officer }}" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Enter name" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-800 mb-1">Checked Officer’s Name</label>
                            <input type="text" name="officer" class="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-500" placeholder="Enter name" />
                        </div>
                        <div>
                ...
                <div class="flex justify-end space-x-4">
                    <button class="px-8 py-3 rounded-3xl border border-red-400 text-red-400 font-semibold hover:bg-red-50 transition">Cancel</button>
                    <button class="px-8 py-3 rounded-3xl bg-teal-500 text-white font-semibold hover:bg-teal-600 transition">Completed</button>
                </div>
                </div>
            </form>
        </main>
