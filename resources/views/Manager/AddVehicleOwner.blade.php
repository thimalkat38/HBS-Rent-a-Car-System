            ...
            <div class="content">
                <form method="POST" action="{{ route('vehicle_owners.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <input type="text" id="rental_amnt" name="rental_amnt" placeholder="Rental Amount"
                                required>
                            <input type="text" id="monthly_km" name="monthly_km" placeholder="Monthly KM"
                                required>
                            <input type="text" id="extra_km_chg" name="extra_km_chg"
                                placeholder="Extra KM Chagers" required>
                        </div>
                        <div class="form-row">
                            <input type="text" id="acc_no" name="acc_no" placeholder="Bank Account Number"
                                required>
                            <input type="text" id="bank_detais" name="bank_detais"
                                placeholder="Bank Details (Bank, Bank Name, Owner Name or etc.)">
                        </div>
                    </div>
                    <!-- Submit Button -->
