...
.form-row {
    ...
    margin-bottom: 20px; /* Space below the form row */
}
...
.left-column, .right-column {
    display: flex;
    flex-direction: column;
    gap: 20px; /* Space between rows within the column */
}
...
.left-inner-row {
    display: grid;
    grid-template-columns: 1fr 1fr; /* Two equal columns */
    column-gap: 30px; /* Space between inner columns */
}
...
.form-row input {
    ...
    width: 100%; /* Full width of each grid column by default */
}

/* Small Input Styles */
.small-input {
    width: 30%; /* Make small inputs narrower */
}

/* EMP ID Input Styles */
.emp-id-input {
    width: 100%; /* Full width to take up the space of two rows */
}

/* Submit Button Styles */
.submit-container {
    text-align: right;
    margin-top: 200px; /* Space before the button */
}
